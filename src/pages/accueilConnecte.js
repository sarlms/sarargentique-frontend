...
import NavBarConnecte from '../component/navbarConnecte';
...
function AccueilConnecte({ user, onLogout, socket}) {
  const [photosData, setPhotosData] = useState([]); // State to store photo data
